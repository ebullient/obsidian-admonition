...
const OB = (name: string) => ({ type: "obsidian" as const, name });

export const ADMONITION_MAP: Record<string, Admonition> = {
    note: {
        type: "note",
        icon: OB("lucide-pencil"),
